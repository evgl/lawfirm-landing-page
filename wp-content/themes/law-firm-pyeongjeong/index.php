...
<section id="consultation-form" class="section consultation-section bg-light">
    <div class="container">
        <div class="section-header">
            <h2 class="section-title"><?php _e('온라인 상담접수', 'law-firm-pyeongjeong'); ?></h2>
            <p class="section-subtitle">
                <?php _e('법률 전문가가 신속하고 정확하게 답변드립니다', 'law-firm-pyeongjeong'); ?>
            </p>
        </div>

        <div class="consultation-form">
            <form id="main-consultation-form" method="post" action="#">
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="consultation-name"><?php _e('이름', 'law-firm-pyeongjeong'); ?> <span class="required">*</span></label>
                        <input type="text" id="consultation-name" name="name" placeholder="<?php esc_attr_e('이름을 입력해주세요', 'law-firm-pyeongjeong'); ?>" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="consultation-phone"><?php _e('연락처', 'law-firm-pyeongjeong'); ?> <span class="required">*</span></label>
                        <input type="tel" id="consultation-phone" name="phone" placeholder="010-0000-0000" required>
                    </div>
                </div>

                <div class="form-group">
                    <label for="consultation-email"><?php _e('이메일', 'law-firm-pyeongjeong'); ?></label>
                    <input type="email" id="consultation-email" name="email" placeholder="example@email.com">
                </div>

                <div class="form-group">
                    <label for="consultation-case-type"><?php _e('사건분야 선택', 'law-firm-pyeongjeong'); ?> <span class="required">*</span></label>
                    <select id="consultation-case-type" name="case_type" class="form-control select" required>
                ...
                <div class="form-group">
                    <label for="consultation-message"><?php _e('문의 내용을 간략히 작성해주세요', 'law-firm-pyeongjeong'); ?></label>
                    <textarea id="consultation-message" name="message" rows="5" placeholder="<?php esc_attr_e('상담받고 싶은 내용을 자세히 적어주시면 더 정확한 답변을 받으실 수 있습니다.', 'law-firm-pyeongjeong'); ?>"></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="privacy-notice">
                        <p><?php _e('수집된 개인정보는 상담 목적으로만 사용되며, 상담 완료 후 파기됩니다.', 'law-firm-pyeongjeong'); ?></p>
                        <a href="<?php echo esc_url(home_url('/privacy-policy')); ?>" target="_blank" class="privacy-link">
                            <?php _e('개인정보처리방침 자세히 보기', 'law-firm-pyeongjeong'); ?>
                        </a>
                    </div>
                </div>
...
<?php
// Display blog posts if this is the blog page
if (is_home() && !is_front_page()) :
    ?>
    <section class="section blog-section">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title"><?php _e('최근 소식', 'law-firm-pyeongjeong'); ?></h2>
            </div>
            ...
            <div class="blog-posts">
                <?php if (have_posts()) : ?>
                            ...
                            <article id="post-<?php the_ID(); ?>" <?php post_class('post-card'); ?>>
                                ...
                                <div class="post-content">
                                    ...
                                    <a href="<?php the_permalink(); ?>" class="read-more">
                                        <?php _e('자세히 읽기', 'law-firm-pyeongjeong'); ?>
                                        <i class="fas fa-arrow-right" aria-hidden="true"></i>
                                    </a>
                                </div>
                            </article>
                    ...
                    the_posts_pagination(array(
                        'mid_size' => 2,
                        'prev_text' => __('&laquo; 이전', 'law-firm-pyeongjeong'),
                        'next_text' => __('다음 &raquo;', 'law-firm-pyeongjeong'),
                    ));
                    ?>
                <?php else : ?>
                    <div class="no-posts-message text-center">
                        <i class="fas fa-file-alt fa-3x mb-3 text-muted" aria-hidden="true"></i>
                        <h3><?php _e('게시된 글이 없습니다', 'law-firm-pyeongjeong'); ?></h3>
                        <p><?php _e('새로운 소식을 곧 공개할 예정입니다.', 'law-firm-pyeongjeong'); ?></p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
