<?php
/**
 * Search News Board Template
 *
 * Template Name: Search News Board Template
 *
...
<!-- Main Content Area -->
<main id="primary" class="site-main search-news-board-template">
    ...
    <section class="search-section">
        <div class="search-section-wrapper">
            ...
            <div class="search-title">
                <h1><?php esc_html_e('언론보도', 'law-firm-pyeongjeong'); ?></h1>
                <p class="search-subtitle">NEWS BOARD</p>
            </div>
            ...
            <div class="search-container">
                <form class="search-bar-form" role="search">
                    <input
                        type="text"
                        class="search-input"
                        placeholder="<?php esc_attr_e('Search news...', 'law-firm-pyeongjeong'); ?>"
                        aria-label="<?php esc_attr_e('Search news', 'law-firm-pyeongjeong'); ?>"
                    >
                ...
                if ($news->have_posts()) :
                    ...
                    <div class="news-list" id="news-list">
                        ...
                        while ($news->have_posts()) : $news->the_post();
                            ...
                            ?>
                            <a href="<?php the_permalink(); ?>" class="news-card <?php echo esc_attr($hidden_class); ?>" data-post-index="<?php echo esc_attr($post_count); ?>" style="text-decoration: none; color: inherit;">
                    ...
                    <div class="load-more-wrapper">
                        <button class="load-more-btn" id="load-more-news-btn">더보기 +</button>
                    </div>
                    <?php endif; ?>

                    <?php
                else :
                    echo '<p class="no-news">' . esc_html__('No news found.', 'law-firm-pyeongjeong') . '</p>';
                endif;
                ?>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    loadMoreBtn.addEventListener('click', function() {
        const hiddenCards = document.querySelectorAll('#news-list .news-card.hidden');
        let count = 0;
        ...
        if (document.querySelectorAll('#news-list .news-card.hidden').length === 0) {
